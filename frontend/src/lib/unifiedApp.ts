...
const features = [
  {
    ...
    summary: 'Cases workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Public',
    icon: Users,
    summary: 'Incidents workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Public',
    icon: ClipboardList,
    summary: 'Units workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Public',
    icon: CalendarCheck,
    summary: 'Schedules workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Evidence workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Permits workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Resources workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Alerts workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Border Customs Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Border Customs Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Border Customs Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Border Customs Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Border Customs Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Border Customs Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIBorderCustomsOperationsAssistant', 'AIBorderCustomsOperationsOperations where applicable'],
