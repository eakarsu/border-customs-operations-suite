...
export const sourceSystems = [
  { name: 'AIBorderCustomsOperationsAssistant', ownership: 'Cases source capabilities and workflows', coverage: ['Cases', 'Incidents', 'Units'] },
  { name: 'AIBorderCustomsOperationsOperations', ownership: 'Incidents source capabilities and workflows', coverage: ['Schedules', 'Evidence', 'Permits'] },
  { name: 'AIBorderCustomsOperationsAnalytics', ownership: 'Units source capabilities and workflows', coverage: ['Approvals', 'Resources', 'Compliance'] },
  { name: 'AIBorderCustomsOperationsWorkflow', ownership: 'Schedules source capabilities and workflows', coverage: ['Alerts', 'Analytics', 'Reports'] },
];
