...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Border Customs Operations Dashboard"
      subtitle="One merged border customs operations view for Cases, Incidents, Units, Schedules, Evidence, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared border customs operations jobs into one surface. Cases, Incidents, Units, Schedules, Evidence, Permits, documents, audit, and AI are presented as platform features.</div>
