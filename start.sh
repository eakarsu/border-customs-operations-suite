...
PORT="${PORT:-4910}"
DB_NAME="${PGDATABASE:-border_customs_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Border Customs Operations Suite"
echo "======================================="
echo
...
echo "Starting border customs operations suite frontend on http://localhost:$PORT"
echo "Login: admin@border-customs-operations.local / admin123"
